...
# 暂时停更，先停更一个月
## 由于工作和身体原因，更重要的是知识原因，我发现我对Emby服了解还是太少了。做这个项目本来是自己玩，没想到有这么多人喜欢，有好心人帮助并给出修改建议，这个项目不断的完善，不断的学习新的知识，让我感觉很充实，感谢大家的喜欢。

### 下一步计划，实现emby前后端分离反代,自定义请求头，全局导入和导出配置，个性化面板完善，全屏节点列表面板按钮，自动测速功能（只是测延迟），故障转移
